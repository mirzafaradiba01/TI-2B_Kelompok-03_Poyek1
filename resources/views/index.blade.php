...
<body>
    ...
    <div class="wrapper">
                ...
                <div>
                    ...
                    <section class="btn-wrapper d-flex gap-5 align-items-center">
                        <form action="#" method="POST">
                            <button class="fw-bold text-capitalize d-flex justify-content-center align-items-center" type="sumbmit">daftar</button>
                        </form>
        ...
        <main class="about-us m-5 px-5 rounded bg-white shadow-lg position-relative" style="height: 500px; border: 2px solid #000">
            <div class="d-flex justify-content-between align-items-center">
                <div class="left">
                    <img src="{{ url('images/about-us.png'); }}" alt="" class="img-one shadow-lg img-fluid rounded position-absolute">
                    <img src="{{ url('images/about-us-2.jpg'); }}" alt="" class="img-two shadow-lg img-fluid rounded position-absolute">
                </div>
                <div class="right">
                    <p class="fs-3 mt-5 text-capitalize fw-bold text-center">tentang kami</p>
                    <p>
                        laundry yang berdiri sejak tahun 2015. berlokasi di jalan soekarnohatta <br> no. 19 malang, yang mampu bersaing dengan daerah sekitarnya
                    </p>
        ...
        <div class="mt-5 bg-info rounded shadow-lg right-content gap-1 d-flex justify-content-evenly align-items-center flex-row">
                ...
                <div class="text-wrapper">
                    ...
                    kami telah memiliki pengalaman selama 25 tahun,
